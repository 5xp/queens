        ...
        <div className="full-game">
            ...
            {loading ? null : (
                <div className="generate-puzzles">
                    ...
                    <div className="slider-label">board size: {boardSize}</div>
                    <Slider
                        value={boardSize}
                        min={4}
                        max={10}
                    ...
                    />
                    <div className="slider-label">difficulty: {difficulty}</div>
                    <Slider
                        value={difficulty}
                        min={0}
                        max={10}
                    ...
                    />
                    {/* get a new board */}
                    <button onClick={getBoard}>new game</button>
                    <br />
